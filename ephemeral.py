...
class Counter(discord.ui.View):
    ...
    async def count(self, interaction: discord.Interaction, button: discord.ui.Button['Counter']):
...
class EphemeralCounterBot(commands.Cog):
    ...
    async def on_ready(self):
        print("Plugin: Ephemral module successfully imported")
...
def setup(bot):
    bot.add_cog(EphemeralCounterBot(bot))